...
<div class="container">
	<div class="row middle-signup">
		...
		<div class="row">
			<div class="col-xs-6 col-md-8 col-lg-10 vcenter-signup">
				Already registered? <a href="<?php echo base_url(); ?>index.php/login">Login Here</a>
			</div>
		</div>

		<div class="row">
	    	<div class="col-xs-6 col-md-8 col-lg-10 vcenter-signup-cpy">
